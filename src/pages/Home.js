...
const Home = (props) => {
  ...
  const tipoDeSubscripcion = 'pro'
  const PrivateRoute = ({component: Component, ...rest}) =>{
    return(
      <Route {...rest}>
          {tipoDeSubscripcion === 'pro'? <Component /> : <Redirect to='/' />}
      </Route>
    )
  }
 	const drawer = (
    <>
      ...
      <Divider />
      <List>
        {["Nuevo Pedido", "Pedidos Pendientes", "Pedidos Entregados"].map((text, index) => (
          <Link
            to={`/${text}`}
      ...
      <BrowserRouter>
        ...
        >
          ...
          <Switch>
            ...
            <Route exact path="/Pedidos Pendientes">
            ...
            <PrivateRoute exact path='/herramientasPRO' component={PrivatePage} />
